    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterSampleApplicationApp.notification.home.createOrEditLabel">
              <Translate contentKey="jhipsterSampleApplicationApp.notification.home.createOrEditLabel">
              ...
              <AvForm model={isNew ? {} : notificationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="dateLabel" for="notification-date">
                    <Translate contentKey="jhipsterSampleApplicationApp.notification.date">Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="detailsLabel" for="notification-details">
                    <Translate contentKey="jhipsterSampleApplicationApp.notification.details">Details</Translate>
                  </Label>
                  <AvField id="notification-details" type="text" name="details" />
                </AvGroup>
                <AvGroup>
                  <Label id="sentDateLabel" for="notification-sentDate">
                    <Translate contentKey="jhipsterSampleApplicationApp.notification.sentDate">Sent Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="formatLabel" for="notification-format">
                    <Translate contentKey="jhipsterSampleApplicationApp.notification.format">Format</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="EMAIL">{translate('jhipsterSampleApplicationApp.NotificationType.EMAIL')}</option>
                    <option value="SMS">{translate('jhipsterSampleApplicationApp.NotificationType.SMS')}</option>
                    <option value="PARCEL">{translate('jhipsterSampleApplicationApp.NotificationType.PARCEL')}</option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label id="userIdLabel" for="notification-userId">
                    <Translate contentKey="jhipsterSampleApplicationApp.notification.userId">User Id</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label id="productIdLabel" for="notification-productId">
                    <Translate contentKey="jhipsterSampleApplicationApp.notification.productId">Product Id</Translate>
                  </Label>
                  <AvField
