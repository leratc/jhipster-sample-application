  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterSampleApplicationApp.notification.delete.question">
          <Translate contentKey="jhipsterSampleApplicationApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
