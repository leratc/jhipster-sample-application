    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterSampleApplicationApp.invoice.home.createOrEditLabel">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : invoiceEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  >
                    <option value="PAID">{translate('jhipsterSampleApplicationApp.InvoiceStatus.PAID')}</option>
                    <option value="ISSUED">{translate('jhipsterSampleApplicationApp.InvoiceStatus.ISSUED')}</option>
                    <option value="CANCELLED">{translate('jhipsterSampleApplicationApp.InvoiceStatus.CANCELLED')}</option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  ...
                  >
                    <option value="CREDIT_CARD">{translate('jhipsterSampleApplicationApp.PaymentMethod.CREDIT_CARD')}</option>
                    <option value="CASH_ON_DELIVERY">{translate('jhipsterSampleApplicationApp.PaymentMethod.CASH_ON_DELIVERY')}</option>
                    <option value="PAYPAL">{translate('jhipsterSampleApplicationApp.PaymentMethod.PAYPAL')}</option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
